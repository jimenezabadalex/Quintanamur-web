...
export const SERVICIOS: Servicio[] = [
  ...
  // ==========================================
  {
    ...
    maquinaria: "Fresadora FI-IVAN + Tractor Fendt",
    maquinariaDetalle: "Fresadora trituradora de piedra FI-IVAN + Tractor Fendt de alta potencia",
    ctaTexto: "Solicitar presupuesto de despedregado",
    pasos: [
      {
        numero: 1,
        titulo: "Inspección de pedregosidad y dureza de roca",
        icono: "search",
      },
      {
        numero: 2,
        titulo: "Fresado y trituración in situ hasta 35 cm",
        icono: "precision_manufacturing",
      },
      {
        numero: 3,
        titulo: "Integración mineral y lecho de siembra óptimo",
        icono: "check_circle",
      },
    ],
    slides: [
      {
        ...
        badge: "Paso 1: Trituración de Roca en Campo",
        titulo: "Fresadora triturando piedra in situ",
        duracion: 5000,
      },
    ],
  },
